...
*(Note: Exactly 4 featured projects. Arrows placed on bottom-right of card. Top-right link routes to all builds. Case study links route to `/projects/[slug]`.)*
...
### 1.5 Experience Dossier
*(Note: Tab-based entity navigation on left with 350px locked container height and bottom gradient scroll mask on right.)*

```markdown
1. Philippine Society of Youth Science Clubs (Feb 2024 to Present)
   • Marketing Associate (Feb 2024 to Present)
     Secured corporate sponsorships generating over ₱800,000 in funding for a national science competition.
   • Regional Head, Region I/II/NCR (May 2024 to Sep 2024)
     Directed regional elimination rounds and MathSciAKa workshops, coordinating 30+ volunteers.
   • Science Olympiad Core, National Science Club Month 2024 (May 2024 to Sep 2024)
...
3. UP Fighting Maroons (Aug 2024 to May 2025)
   ...
   • Co-Founder & Head of Marketing (Aug 2024 to May 2025)
...
4. UP Oblation Esports (Nov 2022 to May 2025)
...
6. UP Fair 2024 (Nov 2023 to Feb 2024)
...
7. miHoYo (HoYoverse) (Oct 2023 to Dec 2024)
...
### 2.13 MLBB Post-Game Extractor (`/projects/mlbb-post-game-extractor`) — Focused
- **Tier:** Focused
- **Category:** Web & Tools
- **Role:** Creator & Developer
- **Timeline:** 2026
- **Platform:** Web
- **Stack:** React 18, Vite, Tesseract.js, HTML5 Canvas, WebAssembly, Web Workers, localStorage, Vitest
- **GitHub URL:** https://github.com/Aedwon/mlbb-post-game-extractor
- **Tagline:** Client-side MLBB screenshot extractor built around configurable crop presets, Tesseract.js OCR, and long or role-positioned CSV exports.
- **Summary:** Browser tool that maps post-game screenshots to five tab presets, slices stat columns into ten player records, checks battle IDs across a batch, and exports match data as a 40-column long CSV or a 226-column wide CSV.

#### Building the batch around crop presets
...
#### The red side needed its own field order
...
#### Exporting a match instead of dumping OCR text
