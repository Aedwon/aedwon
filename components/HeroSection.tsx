...
export default function HeroSection() {
  ...
  if (isNeobrutalist) {
    return (
      <section className="p-6 sm:p-7 bg-[var(--bg-card)] border-[3px] border-black shadow-[5px_5px_0px_#000000] rounded-none">
        <h1 className="text-[25px] sm:text-[27px] font-extrabold text-black tracking-[-0.02em] leading-[1.35] mb-3 font-[var(--font-heading)]">
          I&apos;m Aerol. You might also know me as Aedwon.
        </h1>
        <p className="text-[14.5px] sm:text-[15px] leading-[1.65] text-black/90 max-w-[720px] font-mono">
