...
export default function DiscordServerRail({
  activeChannel = "home",
  onSelectChannel,
}: DiscordServerRailProps) {
  return (
    <nav
    ...
    >
      ...
      >
        <div className="w-12 h-12 rounded-[24px] hover:rounded-[16px] bg-[#313338] hover:bg-[#5865F2] flex items-center justify-center text-gray-300 hover:text-white transition-all duration-200">
      ...
      >
        ...
        <div className="w-12 h-12 rounded-[16px] bg-[#5865F2] flex items-center justify-center text-white font-bold text-lg shadow-lg transition-all duration-200">
          A
        </div>
      </div>
      ...
      {/* External Links as Server Badges */}
      {/* 1. Email */}
      <a
      ...
      {/* Add Server */}
      <div
        className="w-12 h-12 rounded-[24px] hover:rounded-[16px] bg-[#2b2d31] hover:bg-[#23a55a] text-[#23a55a] hover:text-white flex items-center justify-center text-2xl font-light cursor-pointer transition-all duration-200"
        title="Add Server"
      >
        +
      </div>
